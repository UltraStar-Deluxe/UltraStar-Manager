...
void QUMonty::initMessages() {
	...
	messages << QObject::tr("The BPM tag is not editable? Yeah, that's right. This is not a song creation tool like the <a href=\"https://github.com/UltraStar-Deluxe/UltraStar-Creator\">UltraStar-Creator</a>. Nevertheless, you can modify all lyrics and correct spelling errors.");
	...
	messages << QObject::tr("UltraStar Manager is not available in your language? Well, if you are interested in translating, just get in touch with one of the developers at the <a href=\"https://github.com/UltraStar-Deluxe/UltraStar-Manager/issues\">project site</a>.");
