...
macx {
	...
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtNetwork.framework/Versions/5/QtNetwork @executable_path/../Frameworks/QtNetwork.framework/Versions/5/QtNetwork ../bin/release/UltraStarManager.app/Contents/Frameworks/QtMultimedia.framework/Versions/5/QtMultimedia $$escape_expand(\\n\\t)
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtCore.framework/Versions/5/QtCore @executable_path/../Frameworks/QtCore.framework/Versions/5/QtCore ../bin/release/UltraStarManager.app/Contents/Frameworks/QtMultimedia.framework/Versions/5/QtMultimedia $$escape_expand(\\n\\t)
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtGui.framework/Versions/5/QtGui @executable_path/../Frameworks/QtGui.framework/Versions/5/QtGui ../bin/release/UltraStarManager.app/Contents/Frameworks/QtMultimedia.framework/Versions/5/QtMultimedia $$escape_expand(\\n\\t)
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtCore.framework/Versions/5/QtCore @executable_path/../Frameworks/QtCore.framework/Versions/5/QtCore ../bin/release/UltraStarManager.app/Contents/Frameworks/QtNetwork.framework/Versions/5/QtNetwork $$escape_expand(\\n\\t)
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtCore.framework/Versions/5/QtCore @executable_path/../Frameworks/QtCore.framework/Versions/5/QtCore ../bin/release/UltraStarManager.app/Contents/Frameworks/QtXml.framework/Versions/5/QtXml $$escape_expand(\\n\\t)
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtGui.framework/Versions/5/QtGui @executable_path/../Frameworks/QtGui.framework/Versions/5/QtGui ../bin/release/UltraStarManager.app/Contents/PlugIns/platforms/libqcocoa.dylib $$escape_expand(\\n\\t)
