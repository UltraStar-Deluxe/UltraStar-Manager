...
macx {
	...
	QMAKE_POST_LINK += install_name_tool -change /usr/local/Cellar/qt5/5.8.0_1/lib/QtWidgets.framework/Versions/5/QtGui @executable_path/../Frameworks/QtWidgets.framework/Versions/5/QtGui ../bin/release/UltraStarManager.app/Contents/Frameworks/QtPrintSupport.framework/Versions/5/QtPrintSupport $$escape_expand(\\n\\t)
