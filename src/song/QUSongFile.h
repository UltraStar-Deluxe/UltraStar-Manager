...
public:
	...
	static bool hasRapNotesLessThan (QUSongFile *s1, QUSongFile *s2);
...
public:
	...
	virtual QList<QUSongLineInterface*> melodyForSinger(QUSongLineInterface::Singers s = QUSongLineInterface::undefined);
