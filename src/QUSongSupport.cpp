...
QStringList QUSongSupport::availableSongEditions() {
	...
	result << "SingStar Back to the ’80s";
	...
	result << "SingStar Polskie Hity 2";
	result << "SingStar Pop";
	result << "SingStar Pop Edition (PS3)";
	result << "SingStar Popworld";
	result << "SingStar The Dome";
	result << "SingStar Pop 2";
	...
	result << "SingStar Svenska Stjarnor";
	...
	result << "SingStar German";
	result << "SingStar UK";
	result << "SingStar Ultimate Party";
	result << "SingStar Wakacyjna Impreza!";
