...
#define TASKTEXT24 QObject::tr("Change #ARTIST via ID3 tag from audio file.")
#define TASKTEXT25 QObject::tr("Change #TITLE via ID3 tag from audio file.")
#define TASKTEXT26 QObject::tr("Change #TITLE via ID3 tag from audio file. Append \"[VIDEO]\" if video present.")
#define TASKTEXT27 QObject::tr("Change #TITLE. Append \"[VIDEO]\" if video present.")
#define TASKTEXT28 QObject::tr("Do not use ID3 tag information.")
#define TASKTEXT29 QObject::tr("Change #TITLE. Remove [...]-Tags.")
#define TASKTEXT30 QObject::tr("Do not use ID3 tag information.")
#define TASKTEXT31 QObject::tr("Change #GENRE via ID3 tag.")
#define TASKTEXT32 QObject::tr("Change #YEAR via ID3 tag.")
#define TASKTEXT33 QObject::tr("Change #ALBUM via ID3 tag")
#define TASKTEXT34 QObject::tr("You need the custom tag #ALBUM for this task.")
