	...
	_mode(mode)
{
	...
	case QU::useArtist:
		...
		this->setDescription("Use ID3 tag for artist");
		break;
	case QU::useTitle:
		this->setIcon(QIcon(":/types/font.png"));
		this->setDescription("Use ID3 tag for title");
		break;
	case QU::useGenre:
		this->setIcon(QIcon(":/types/genre.png"));
		this->setDescription("Use ID3 tag for genre");
		break;
	case QU::useYear:
		this->setIcon(QIcon(":/types/date.png"));
		this->setDescription("Use ID3 tag for year");
		break;
	}
}
