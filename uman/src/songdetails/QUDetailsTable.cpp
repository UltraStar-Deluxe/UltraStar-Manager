...
void QUDetailsTable::initTagColumn() {
	this->initSeparator(tr("Information"), 0);
        ...
        this->setItem(13, 0, new QUTagItem(QIcon(":/types/film.png"), tr("Video")));
        ...
        this->setItem(20, 0, new QUTagItem(QIcon(":/bullets/bullet_black.png"), tr("MedleyStartBeat")));
        this->setItem(21, 0, new QUTagItem(QIcon(":/bullets/bullet_black.png"), tr("MedleyEndBeat")));
        this->setItem(22, 0, new QUTagItem(QIcon(":/bullets/bullet_black.png"), tr("BPM")));
        this->setItem(23, 0, new QUTagItem(QIcon(":/bullets/bullet_black.png"), tr("Gap")));

        this->initSeparator(tr("Custom"), 24);
        //this->setItem(25, 0, new QUTagItem(QIcon(":/types/comment.png"), tr("Comment")));
	int i = 0;
	foreach(QString customTag, QUSongSupport::availableCustomTags()) {
                this->setItem(25 + (i++), 0, new QUTagItem(QIcon(":/bullets/bullet_star.png"), customTag));
	}
}

void QUDetailsTable::initValueColumn() {
	/* separator here - skip a row */
        this->setItem(1, 1, new QUDetailItem(ENCODING_TAG));
        this->setItem(2, 1, new QUDetailItem(TITLE_TAG));
        this->setItem(3, 1, new QUDetailItem(ARTIST_TAG));
        this->setItem(4, 1, new QUDetailItem(LANGUAGE_TAG));
        this->setItem(5, 1, new QUDetailItem(EDITION_TAG));
        this->setItem(6, 1, new QUDetailItem(GENRE_TAG));
        this->setItem(7, 1, new QUDetailItem(YEAR_TAG));
        this->setItem(8, 1, new QUDetailItem(CREATOR_TAG));

	/* separator here - skip a row */
        this->setItem(10, 1, new QUDetailItem(MP3_TAG));
        this->setItem(11, 1, new QUDetailItem(COVER_TAG));
        this->setItem(12, 1, new QUDetailItem(BACKGROUND_TAG));
        this->setItem(13, 1, new QUDetailItem(VIDEO_TAG));

	/* separator here - skip a row */
        this->setItem(15, 1, new QUDetailItem(VIDEOGAP_TAG));
        this->setItem(16, 1, new QUDetailItem(START_TAG));
        this->setItem(17, 1, new QUDetailItem(END_TAG));
        this->setItem(18, 1, new QUDetailItem(RELATIVE_TAG));
        this->setItem(19, 1, new QUDetailItem(PREVIEWSTART_TAG));
        this->setItem(20, 1, new QUDetailItem(MEDLEYSTARTBEAT_TAG));
        this->setItem(21, 1, new QUDetailItem(MEDLEYENDBEAT_TAG));
        this->setItem(22, 1, new QUDetailItem(BPM_TAG));
        this->setItem(23, 1, new QUDetailItem(GAP_TAG));

	/* separator here - skip a row */
	int i = 0;
	foreach(QString customTag, QUSongSupport::availableCustomTags()) {
                this->setItem(25 + (i++), 1, new QUDetailItem(customTag));
	}
}
...
void QUDetailsTable::reset() {
        this->setRowCount(25 + QUSongSupport::availableCustomTags().size());
