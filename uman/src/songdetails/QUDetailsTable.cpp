...
void QUDetailsTable::initTagColumn() {
	...
	this->setItem(20, 0, new QUTagItem(QIcon(":/types/medley_calc.png"),		tr("CalcMedley")));
	this->setItem(21, 0, new QUTagItem(QIcon(":/types/medley_start_beat.png"),	tr("MedleyStartBeat")));
	this->setItem(22, 0, new QUTagItem(QIcon(":/types/medley_end_beat.png"),	tr("MedleyEndBeat")));
...
void QUDetailsTable::initValueColumn() {
	...
	this->setItem(20, 1, new QUDetailItem(CALCMEDLEY_TAG));
	this->setItem(21, 1, new QUDetailItem(MEDLEYSTARTBEAT_TAG));
	this->setItem(22, 1, new QUDetailItem(MEDLEYENDBEAT_TAG));
	this->setItem(23, 1, new QUDetailItem(BPM_TAG));
	this->setItem(24, 1, new QUDetailItem(GAP_TAG));

	/* separator here - skip a row */
	int i = 0;
	foreach(QString customTag, QUSongSupport::availableCustomTags()) {
		this->setItem(26 + (i++), 1, new QUDetailItem(customTag));
	}
}
...
void QUDetailsTable::reset() {
	this->setRowCount(26 + QUSongSupport::availableCustomTags().size());
